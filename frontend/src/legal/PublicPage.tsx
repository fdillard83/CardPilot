...
function AboutContent() {
  return (
    <div className="public-page-sections">
      ...
      <section><h2>Safe selling workflow</h2><p>Connecting eBay alone does not publish a card. Preview mode and the current Autopilot testing mode both require the account owner to confirm publication with the eBay publish button. Autopilot prepares cards that satisfy the owner’s identification-confidence, pricing, and value safeguards; cards outside those safeguards wait for review. Sandbox testing remains isolated from the real eBay marketplace.</p></section>
...
function PrivacyContent() {
  return (
    <div className="public-page-sections">
      ...
      <section><h2>How information is used</h2><p>This information is used to authenticate the collector, identify and organize cards, prepare market comparisons and valuations, synchronize a private collection, recover account data, and perform eBay actions the collector directly requests or pre-authorizes through account-level Autopilot safeguards.</p></section>
      <section><h2>Service providers</h2><p>CardPilot uses service providers including Supabase for accounts and private storage, OpenAI for image-assisted identification, Google Cloud Vision for optional web-image evidence, eBay for market searches and authorized selling, Render for application hosting, and specialized catalog or market-data providers when enabled. Only information needed for the requested feature is sent to a provider.</p></section>
